...
//import io.swagger.client.api.HtmlApi;
...
HtmlApi apiInstance = new HtmlApi();
String taskId = "taskId_example"; // String | 
try {
    AsyncResponseHtmlAnalysisResponse result = apiInstance.get(taskId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling HtmlApi#get");
    e.printStackTrace();
}
```
...
HtmlApi apiInstance = new HtmlApi();
HtmlAnalysisRequest requestp = new HtmlAnalysisRequest(); // HtmlAnalysisRequest | 
try {
    AsyncResponseHtmlAnalysisResponse result = apiInstance.post(requestp);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling HtmlApi#post");
    e.printStackTrace();
}
```
