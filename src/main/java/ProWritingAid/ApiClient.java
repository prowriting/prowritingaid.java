...
import ProWritingAid.auth.Authentication;
import ProWritingAid.auth.HttpBasicAuth;
import ProWritingAid.auth.ApiKeyAuth;
import ProWritingAid.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.prowritingaid.com";
    ...
    public ApiClient() {
        ...
        authentications.put("licenseCode", new ApiKeyAuth("header", "licenseCode"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.prowritingaid.com
